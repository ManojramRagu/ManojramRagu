...
### Undergraduate BEng (Hons) Software Engineering | APIIT 🎓

Passionate Software Engineering student with a focus on building scalable web applications and implementing industry-standard **Agile methodologies**. I specialize in full-stack development, seamless **CI/CD pipelines**, and professional hosting solutions.

---

## 🌐 Connect with Me:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/manojram-ragu) 
[![Email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:manojramragu@gmail.com) 
...
* **Agile Development:** Experienced in mimicking industry-level agile processes within collaborative student environments (Commercial Computing).
* **Deployment & Hosting:** Proficient in configuring **Netlify** for front-end hosting and managing cloud-based databases via **Supabase** and **MySQL**.
